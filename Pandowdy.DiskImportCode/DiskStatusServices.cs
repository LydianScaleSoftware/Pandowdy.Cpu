...
public sealed class DiskStatusProvider : IDiskStatusMutator
{
    ...
    /// <summary>
    /// Converts slot and drive numbers to a unique lookup key.
    /// </summary>
    private static int GetDriveKey(int slotNumber, int driveNumber)
    {
        // Formula: key = (slot * 10) + drive
        // S1D1 = 11, S1D2 = 12, S6D1 = 61, S6D2 = 62, etc.
        return (slotNumber * 10) + driveNumber;
    }
