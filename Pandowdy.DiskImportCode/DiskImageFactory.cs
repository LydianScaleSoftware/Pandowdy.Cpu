...
public class DiskImageFactory : IDiskImageFactory
{
    ...
    public IDiskImageProvider CreateProvider(string filePath)
    {
        ...
        return extension switch
        {
            ...
            ".woz" => new InternalWozDiskImageProvider(filePath), // Native WOZ parser (no CiderPress2 dependency)
            //".woz" => new WozDiskImageProvider(filePath), //  CiderPress2 WOZ parser dependency
