...
public class DiskStatusWidgetViewModel : ReactiveObject
{
    ...
    public DiskStatusWidgetViewModel(DiskDriveStatusSnapshot initialSnapshot)
    {
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item>"M+" = Motor running</item>
    /// <item>"M" = Motor off</item>
    /// <item>"M-" = Motor-off scheduled (delayed)</item>
    /// </list>
    /// </remarks>
