    ...
    IDiskImageStore diskImageStore) : DiskIIControllerCard(cpuClocking, factory, statusMutator, responseEmitter, diskImageStore)
{
    ...
    {
        return new DiskIIControllerCard16Sector(_clocking, _diskIIFactory, _statusMutator, _responseEmitter, _diskImageStore);
    }

    /// <inheritdoc />
    public override ICard CreateWithStore(IDiskImageStore diskImageStore)
    {
        return new DiskIIControllerCard16Sector(_clocking, _diskIIFactory, _statusMutator, _responseEmitter, diskImageStore);
    }
}
