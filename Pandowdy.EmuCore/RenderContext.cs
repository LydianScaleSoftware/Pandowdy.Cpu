...
namespace Pandowdy.EmuCore
{
    ...
    {
        private BitmapDataArray _frameBuffer;
        private IDirectMemoryPoolReader _memory;
        private ISystemStatusProvider _systemStatus;
            ...
            ISystemStatusProvider status)
        {
            ...
            _systemStatus = status ?? throw new ArgumentNullException(nameof(status));
        }
